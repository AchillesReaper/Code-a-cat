...
void drawTail() {
  ...
  float y2 = random(tailStartY - tailLength/5*catHeight*size, tailStartY - tailLength/2*catHeight*size);
  float y3 = random(tailStartY - tailLength/4*catHeight*size, tailStartY - tailLength*catHeight*size);
